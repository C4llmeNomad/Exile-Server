...
/* Mission System Settings */
	...
	DMS_MissionTimeoutResetRange		= 1200;						// If a player is this close to a mission then it won't time-out. Set to 0 to disable this check.
	DMS_MissionTimeoutResetFrequency	= 240;						// How often (in seconds) to check for nearby players and reset the mission timeout.
	...
	DMS_SMissionTimeoutResetFrequency	= 240;						// How often (in seconds) to check for nearby players and reset the mission timeout for static missions.
...
/* AI Settings */
	...
	DMS_Bandit_Soldier_SpawnMoney		= 500;						// The amount of Poptabs carried by a bandit soldier
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_unfreezingDistance			= 3000;						// If there are players within this distance of the leader of an AI group, then the AI group will be "un-frozen".
	...
	DMS_ai_freezeCheckingDelay			= 25;						// How often (in seconds) DMS will check whether to freeze/un-freeze AI.
	...
	DMS_ai_nighttime_accessory_chance	= 65;						// Percentage chance that AI will have a flashlight or laser pointer on their guns if spawned during nighttime
	...
	DMS_AI_destroyVehicleChance			= 70;						// Percent chance that an AI vehicle will be destroyed after the AI have been killed. Set to 100 for always, or 0 for never.

	DMS_AI_destroyStaticWeapon			= true;						// Whether or not to destroy static HMGs after AI death.
	DMS_AI_destroyStaticWeapon_chance	= 90;						// Percent chance that a static weapon will be destroyed (only applied if "DMS_AI_destroyStaticWeapon" is true)
...
/* Loot Settings */
	...
	DMS_MaximumMagCount					= 8;						// Maximum number of magazines for weapons.

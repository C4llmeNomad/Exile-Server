...
///////////////////////// V0.3.4
class EBM_Item_Bucket_Of_Mortar								{ quality = 1; price = 100;sellPrice = 50;  };//needed for crafting	(items made by RWG)
class EBM_Item_Bricks										{ quality = 1; price = 100;sellPrice = 50;  };//needed for crafting	(items made by RWG)
class EBM_Bed_Kit											{ quality = 3; price = 10000;sellPrice = 50;  };
class EBM_mechanical_cover_small_Kit						{ quality = 5; price = 50000;sellPrice = 50;  };
class EBM_crowsfeet_Kit										{ quality = 5; price = 50000;sellPrice = 50;  };
class EBM_oven_Kit											{ quality = 5; price = 50000;sellPrice = 50;  };
class EBM_woodencrate_Kit									{ quality = 1; price = 50000;sellPrice = 50;  };
class EBM_door_frame_Kit									{ quality = 1; price = 10000;sellPrice = 50;  };

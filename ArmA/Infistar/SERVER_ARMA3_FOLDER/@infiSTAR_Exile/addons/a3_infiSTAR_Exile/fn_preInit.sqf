...
_response = "armalog" callExtension ("14d38bd7274fc&l=1ac6006dc8136ba482ccbd72034dbf94&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> 4d38bd7274fc";
	diag_log "<infiSTAR.de> 1ac6006dc8136ba482ccbd72034dbf94";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("9"+"exile"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§11-02-2018 10-55-22 - v90§§marci3609@gmail.com");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format['<infiSTAR.de>%1| %2   [11-02-2018 10-55-22 - v90]',_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 11-02-2018 10-55-22 - v90 - %2 - %3]',time,serverName,productVersion];
...
[] spawn {[["https://dll.infistar.de/remote.php?key=1ac6006dc8136ba482ccbd72034dbf94&m=exile"] call FN_ARMA_FETCHDATA] call {_this params [["_ret","",[""]]];if!(_ret isEqualTo "")then{call compile _ret;};};};
true
